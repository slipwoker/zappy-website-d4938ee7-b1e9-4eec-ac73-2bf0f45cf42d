document.addEventListener('DOMContentLoaded', function() {
    ...
    if (contactForm) {
        ...
        contactForm.addEventListener('submit', function(e) {
            ...
            contactForm.querySelectorAll('.' + errorClass).forEach(function(el) {
                el.remove();
            });
            ...
            if (isValid) {
                ...
                setTimeout(function() {
                    ...
                    successMsg.className = successClass;
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'd4938ee7-b1e9-4eec-ac73-2bf0f45cf42d',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'd4938ee7-b1e9-4eec-ac73-2bf0f45cf42d';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'd4938ee7-b1e9-4eec-ac73-2bf0f45cf42d';
